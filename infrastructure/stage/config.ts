import {
  ...
  PROD_PIERIANDX_TEST_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_ONCOANALYSER_WGTS_DNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_SASH_WGTS_DNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_DRAGEN_WGTS_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_ARRIBA_WGTS_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_ONCOANALYSER_WGTS_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_ONCOANALYSER_WGTS_DNA_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  PROD_RNASUM_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
  ...
  PROD_CLOUDFORMATION_STACKS_TO_MONITOR_BY_WORKFLOW_NAME,
  SSM_PARAMETER_PATH_GIT_STACK_LIST_PREFIX,
} from './constants';
  ...
  if (stage === 'PROD') {
    return {
      ...
      preDraftDataConfigurations: {
        ...
        pieriandxTso500Ctdna: PROD_PIERIANDX_TEST_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
        ...
        dragenWgtsRna: PROD_DRAGEN_WGTS_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
        arribaWgtsRna: PROD_ARRIBA_WGTS_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
        oncoanalyserWgtsRna: PROD_ONCOANALYSER_WGTS_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
        oncoanalyserWgtsDnaRna:
          PROD_ONCOANALYSER_WGTS_DNA_RNA_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
        rnasum: PROD_RNASUM_SAMPLES_PRE_DRAFT_DATA_CONFIGURATIONS,
      },
      s3DeploymentSnapshotPrefix: `s3://${ANALYSIS_GLUE_ARTEFACTS_BUCKET_NAME[stage]}/${DEPLOYMENT_SNAPSHOTS_S3_PREFIX}`,
      gitStacksToObserveByWorkflowName: PROD_CLOUDFORMATION_STACKS_TO_MONITOR_BY_WORKFLOW_NAME,
    };
  }
...
export const getSsmParameterPaths = (stage: StageName): SsmParameterPaths => {
  ...
  if (stage === 'PROD') {
    return {
      ...
      gitStacksToObservePrefix: SSM_PARAMETER_PATH_GIT_STACK_LIST_PREFIX,
    };
  }
  return ssmParametersBase;
};
